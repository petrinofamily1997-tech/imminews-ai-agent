...
def generate_content(news_entry):
    print("🤖 AI is analyzing with DeepSeek V4 Flash...")
    ...
    prompt = f"""
Summarize this news article for a social media news bot.
...
TELEGRAM: (English news summary with relevant emojis. Clear and informative. 2-4 sentences.)

X_POST: (Short English post suitable for X/Twitter. Include relevant hashtags.)
"""
