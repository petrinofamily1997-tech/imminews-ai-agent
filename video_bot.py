...
PHOTO_DURATION = 3.0  # ДОБАВЛЕНО - длительность показа рекламного фото
...
def check_environment():
    ...
    # ДОБАВЛЕНО - проверка наличия фото (не критично)
...
def create_video(
    ...
    # ДОБАВЛЕНО - информация о рекламе
    if PHOTO_FILE.exists():
        print(
