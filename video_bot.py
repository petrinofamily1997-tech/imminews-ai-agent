...
# Длительность показа рекламной картинки
PHOTO_DURATION = 3.0  # Добавлено
...
def create_visual_track(
    ...
    # --------------------------------------------------------
    # Определяем длительность для основной части видео
    # (без учета рекламного кадра)
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Создаем рекламный кадр из фото
    # --------------------------------------------------------
...
def create_video(
    ...
    # Voice is the master clock + реклама
    target_duration = (
        voice_duration
        + VOICE_TAIL
        + PHOTO_DURATION  # Добавляем время на рекламу
    )
