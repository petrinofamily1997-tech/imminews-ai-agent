...
MIN_SUBTITLE_SECONDS = 0.9
MAX_SUBTITLE_SECONDS = 3.2
MAX_WORDS_PER_GROUP = 4
MAX_CHARS_PER_GROUP = 34
...
MONEY_TOPICS = [
    ...
    "почему богатые думают о времени, а не о деньгах",
    "разница между активом и пассивом простыми словами",
    "почему откладывать 10% зарплаты не работает для всех",
    "как банки зарабатывают на обычных людях",
    "иллюзия финансовой безопасности",
    "почему высокий доход не спасает от бедности",
    "ошибка мышления 'заработаю больше — решу проблемы'",
    "как реклама заставляет тратить больше",
    "почему кредитная карта — это не твои деньги",
    "финансовая грамотность, которой не учат в школе",
    "почему сравнение себя с другими разоряет",
    "ловушка рассрочки 0%",
    "что такое финансовая подушка и почему у большинства её нет",
    "почему инвестировать страшно, но не инвестировать — страшнее",
    "как страх упущенной выгоды толкает на плохие сделки",
    "почему богатство — это привычки, а не удача",
    "разница между ценой и ценностью",
    "почему большинство лотерейных миллионеров теряют всё",
    "как маленькие ежедневные траты превращаются в большие суммы",
    "почему откладывать 'на потом' не работает",
    "ошибка держать все деньги на одном счету",
    "почему высокий кредитный рейтинг — не признак богатства",
    "как выйти из цикла 'зарплата — до зарплаты'",
    "почему статус дороже, чем кажется",
    "инфляция образа жизни и как в неё не попасть",
    "почему деньги любят учёт",
    "разница между инвестицией и спекуляцией",
    "почему бедность — это не только про деньги",
    "как эмоции разрушают финансовые решения",
    "почему пассивный доход не бывает быстрым",
    "ловушка сравнения зарплат в соцсетях",
]
...
def generate_voice(script):
    ...
    # Pronunciation-only correction. Subtitles continue to use the normal script.
...
def make_subtitles(script, duration):
    ...
    for word in words:
        ...
        if reached_max_words or reached_max_chars or reached_max_time or reached_min_time:
